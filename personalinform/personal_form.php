...
<html lang = "ja">
  ...
  <body bgcolor="#fffacd  " TEXT="#333333  " LINK="#3333cc  ">
    ...
    <form action="./personalinfo.php" method="post">
      <table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin: 2px 0pt 0pt 0px;">
	      <tr>
	          <td bgcolor="#008b8b  ">
		...
		              <td style="background-color: #ffffff  ;">
		  <input type="text" name="height" size="30"></td>
		      </tr>
		      <tr>
		              <td style="background-color: #87cefa  ;">体重</td>
		              <td style="background-color: #ffffff  ;">
			  <input type="text" name="weight" size="30"></td>
		                  </tr>
	      	      <tr>
